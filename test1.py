...
TOKEN = "7649783739:AAGsp-otPV60psR-9KJNVwX_dTX9cXWl4ts"  # Replace with your bot's token
    ...
    while True:
        ...
        if current_time == "00:00":
            ...
            for user_id in user_reminders:
                bot.send_message(user_id, "Here are today's free Udemy courses:\n\n" + "\n\n".join(courses[:]))
